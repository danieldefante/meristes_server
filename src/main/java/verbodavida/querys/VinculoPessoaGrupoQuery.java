...
public class VinculoPessoaGrupoQuery {
...
//	}
	...
	public static String getQueryVinculoPessoaGrupo() {
		return new StringBuilder()
				.append(" from VinculoPessoaGrupo v ")
				.append(" WHERE v.classificacaoMembro.idclassificacaoMembro = :idClassificacaoMembro ")
				.append(" AND v.grupo.idgrupo = :idGrupo ")
				.append(" AND v.grupo.ministerio.idministerio = :idMinisterio ")
				.append(" AND v.pessoa.idpessoa = :idPessoa ")
				.toString();
	}
